    ...
    return (
        <div className="flex flex-col h-screen font-sans bg-background">
            ...
            <header className="bg-gradient-to-r from-primary to-secondary text-white shadow-md p-4 flex items-center justify-between">
                ...
                <div className="h-6 w-36 bg-white/30 rounded-md"></div>
            ...
            <main className="flex-grow overflow-y-auto p-4 pb-20 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 border-t-4 border-amber-400">
                ...
                <div className="flex justify-around max-w-2xl mx-auto">
                    {Array.from({ length: 8 }).map((_, index) => (
                        <div key={index} className="flex flex-col items-center justify-center w-full pt-2 pb-1">
                             <div className="w-6 h-6 mb-1 bg-purple-200/30 rounded-md"></div>
                             <div className="w-12 h-2 bg-purple-200/30 rounded"></div>
                        </div>
                    ))}
                </div>
            </nav>
