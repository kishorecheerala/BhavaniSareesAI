...
const Card: React.FC<CardProps> = ({ children, className = '', title, ...props }) => {
  return (
    <div className={`bg-white dark:bg-slate-800 rounded-lg shadow-md p-4 sm:p-6 border-t-4 border-primary transition-all duration-300 hover:shadow-xl ${className}`} {...props}>
